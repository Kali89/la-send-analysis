...
One further caveat on the accountability argument. The government's 2026 white paper frames the problem as a structural design failure — the 2014 Act created perverse incentives, inadequate funding mechanisms, and unworkable demand-management triggers that no amount of early management could have fixed without legislative change. That analysis is not wrong. Structural reform of the kind the white paper proposes was also needed. But the structural redesign argument does not exculpate the failure to act on low-regret interventions — these are complementary responses on different timescales, not alternatives. A government pursuing legislative reform from 2018 could simultaneously have expanded EP training places and commissioned a capacity audit. The absence of those actions is not explained by the need for structural change.
