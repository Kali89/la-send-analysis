...
The first full year of EHCP data (2015/16, published mid-2016) showed that the original impact assessment's one-to-one conversion assumption was already wrong: EHCP numbers were above Statement numbers and rising. That is enough to commission analysis, not enough to require capital expenditure. By 2016/17 — two consecutive years of above-expectation growth, with ASD and SEMH visibly driving the trend and some local authorities already showing rising independent top-up spend in the S251 data — a competent government had sufficient evidence to act on the cheap, long-lead interventions. Two years of confirmed trend in a statutory demand-led system, with a known multi-year delivery lag on the relevant responses, is a reasonable threshold for action. Waiting for a third or fourth year while the pipeline stood empty is where the obligation was missed.

By that standard, three things should have happened by 2016/17: an announcement of expanded EP training places (cheap, four-year lead time, obvious bottleneck); publication of national EHCP quality standards (months to develop, reduces plan-writing burden and tribunal risk); and a maintained specialist capacity audit to map where provision would need to grow. None of these require certainty about where demand ends up — they are the right actions under a range of plausible scenarios. By 2017/18, when three years of data made the structural shift unambiguous and DSG stress was emerging in the published S251 returns, the case for a capital programme for resourced provision within mainstream schools — the fastest way to create local maintained alternatives to independent placements — was clear.

It would not be fair to require new special school construction before 2017/18, when the trend was not yet confirmed over multiple years. It would not be fair to require precise predictions about where ASD prevalence would land in 2030. What is fair to require is that a government operating a statutory entitlement system with known long-lead interventions begins those interventions once a demand trend is confirmed. By 2016/17 that threshold was met; by 2019/20, when the government was still largely reacting to individual LA crises rather than running a structural capacity programme, it was inexcusably overdue. Most of what eventually appeared in the 2023 SEND and AP Improvement Plan — more EP training, quality standards, capital for specialist provision — was the right response. It arrived roughly six years too late to prevent the crisis it was responding to.
