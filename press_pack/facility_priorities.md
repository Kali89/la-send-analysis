...
**"Gap (children)"** is the designation planning gap — children with that EHCP primary need type whose need exceeds the maintained sector's designated capacity share. It is not a count of children who need a specialist school place. Many will be in mainstream with support. It represents the scale of structural mismatch between demand profile and designated supply, and therefore the programme size required to address it.
...
| 7 | Lancashire | North West | ASD | Resourced provision unit | **Preston / north Lancashire** | 1–2 yrs | 3,517 | ×2.0 |
...
| 13 | Bradford | Yorkshire and The Humber | SEMH | **New special school** | **Bradford / Shipley area** | 4–6 yrs | 1,746 | ×2.1 |
...
| 19 | Nottinghamshire | East Midlands | ASD | Resourced provision unit | **Mansfield** | 1–2 yrs | 1,761 | ×2.1 |
...
**The single most urgent action is an SEMH resourced provision programme.** Ranks 1 (Hampshire, 3,602-child designation mismatch), 3 (Norfolk, 2,663), and 15 (Surrey, 2,156) all have maintained schools within range that lack SEMH designation. Each entry in the table represents an *area-wide programme* of RPUs distributed across the LA — not a single 25-place unit. These programmes can be open within 1–2 years and do not require new-build.
